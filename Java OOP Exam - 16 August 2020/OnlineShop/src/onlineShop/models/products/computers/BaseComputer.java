...
public abstract class BaseComputer extends BaseProduct implements Computer {
    ...
    public String toString() {
        ...
        double averagePeripheralPerformance = getPeripherals().stream().mapToDouble(Peripheral::getOverallPerformance).average().orElse(0);
        sb.append(String.format(" " + COMPUTER_PERIPHERALS_TO_STRING, peripherals.size(), averagePeripheralPerformance));
        sb.append(System.lineSeparator());
