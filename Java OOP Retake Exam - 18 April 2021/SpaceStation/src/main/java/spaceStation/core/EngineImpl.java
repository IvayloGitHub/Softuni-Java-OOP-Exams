...
public class EngineImpl implements Engine {
    ...
    private String addPlanet(String[] data) {
        String planetName = data[0];
        String[] data1 = Arrays.stream(data).skip(1).toArray(String[]::new);

        return this.controller.addPlanet(planetName, data1);
    }

    private String addAstronaut(String[] data) {
        String astronautType = data[0];
        String astronautName = data[1];
        return this.controller.addAstronaut(astronautType, astronautName);
    }
}
